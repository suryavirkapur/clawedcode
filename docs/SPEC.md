...
- local source inspection of `clank-src/main.tsx`
- local source inspection of `clank-src/screens/REPL.tsx`
- local source inspection of `clank-src/services/api/claude.ts`
- local source inspection of `clank-src/services/mcp/client.ts`
